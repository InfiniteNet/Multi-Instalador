...
versao() {
echo -e "\e[97mComunidade: \e[32mhttps://chat.whatsapp.com/EmmgJiSlpeFJd1PAFOS7xz          \e[97mVersão do SetupOrion: \e[32mv.2.5.3\e[0m"
}
...
direitos_setup() {
    ...
    echo -e "$amarelo=  $branco   mas deve sempre declarar que autombot (contato@autombot.art.br) é o autor original  $amarelo  =\e[0m"
    echo -e "$amarelo=  $branco           destes códigos e atribuir um link para https://autombot.art.br/setup           $amarelo  =\e[0m"
    echo -e "$amarelo=                                                                                                 =\e[0m"
    echo -e "$amarelo===================================================================================================\e[0m"
    echo ""
    echo ""
...
info_credenciais(){ 
    ...
    echo -e "$amarelo=  $branco   do proprio portainer através de uma requsição api. Para que esta nova função funcione em   $amarelo =\e[0m"
...
creditos_msg() {
    ...
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
    echo -e "$amarelo=                                      pix@autombot.art.br                                     $amarelo=\e[0m"
    echo -e "$amarelo=                                                                                                 $amarelo=\e[0m"
...
menu_instalador(){
    ...
    echo -e "${amarelo}[ 17 ]${reset} - ${branco}Mautic                                  ${verde}| ${reset}  ${amarelo}[ 40 ]${reset} - ${branco}Supabase ${verde}[NOVO]${reset}"
    echo -e "${amarelo}[ 18 ]${reset} - ${branco}Appsmith                                ${verde}| ${reset}  ${amarelo}[ 41 ]${reset} - ${branco}REMOVER STACK${reset}"
    echo -e "${amarelo}[ 19 ]${reset} - ${branco}Qdrant                                  ${verde}| ${reset}  ${amarelo}[ 42 ]${reset} - ${branco}Sair do instalador${reset}"
...
criar_arquivo() {
    ...
    read -p "Digite a Url do Portainer (ex: portainer.autombot.art.br): " PORTAINER_URL
    echo ""
...
criar_banco_pgvector_woofedcrm() {
    while :; do
        if docker ps -q --filter "name=pgvector" | grep -q .; then
            CONTAINER_PGVECTOR_ID=$(docker ps -q --filter "name=pgvector")

            # Verificar se o banco de dados já existe
            docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -lqt | cut -d \| -f 1 | grep -qw "woofedcrm"
            ...
            if [ $? -eq 0 ]; then
                ...
                if [ "$resposta" == "Y" ] || [ "$resposta" == "y" ]; then
                    # Apagar o banco de dados
                    docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -c "DROP DATABASE IF EXISTS woofedcrm;"
                    echo "Banco de dados woofedcrm apagado com sucesso."
                    
                    # Criar o banco de dados novamente
                    docker exec "$CONTAINER_PGVECTOR_ID" psql -U postgres -c "CREATE DATABASE woofedcrm;"
...
echo -en "\e[33mDigite o endereço de Email (ex: contato@autombot.art.br): \e[0m" && read -r email_teste
echo ""

echo -e "\e[97mPasso$amarelo 2/5\e[0m"
echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
echo -en "\e[33mDigite o usuário de Email (ex: autombot ou contato@autombot.art.br): \e[0m" && read -r user_teste
echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Portainer (ex: portainer.autombot.art.br): \e[0m" && read -r url_portainer
    echo ""
    ...
    echo -en "\e[33mDigite um endereço de Email válido (ex: contato@autombot.art.br): \e[0m" && read -r email_ssl
    echo ""
...
if [ $? -eq 0 ]; then
    ...
    echo "1/2 - [ OFF ] - Criando Stack"
    echo "Ops, não foi criar a stack do PgVector."
fi
STACK_NAME="pgvector"
stack_editavel > /dev/null 2>&1
if [ $? -eq 0 ]; then
...
while true; do
    ...
    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o Dominio para o Chatwoot (ex: chatwoot.autombot.art.br): \e[0m" && read -r url_chatwoot
    echo ""
    ...
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_admin_chatwoot
    echo ""
...
## --------------------------- ORION --------------------------- ##
  ...
  chatwoot_app:
    ...
    environment:
      ...
      - CHATWOOT_HUB_URL=https://autombot.art.br/setup#
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para a Evolution API (ex: api.autombot.art.br): \e[0m" && read -r url_evolution
    echo ""
...
## --------------------------- ORION --------------------------- ##
  ...
  evolution_autombot:
    ...
    volumes:
    - evolution_autombot_instances:/evolution/instances
    - evolution_autombot_store:/evolution/store
    - evolution_autombot_views:/evolution/views
...
volumes:
  evolution_autombot_instances:
    external: true
    name: evolution_autombot_instances
  evolution_autombot_store:
    external: true
    name: evolution_autombot_store
  evolution_autombot_views:
    external: true
    name: evolution_autombot_views
networks:
  $nome_rede_interna: ## Nome da rede interna
    name: $nome_rede_interna ## Nome da rede interna
    external: true
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o MinIO (ex: minio.autombot.art.br): \e[0m" && read -r url_minio
    echo ""
    
    ##Pergunta o Dominio para o S3 do Minio
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Minio S3 (ex: s3.autombot.art.br): \e[0m" && read -r url_s3
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para o Builder do Typebot (ex: typebot.autombot.art.br): \e[0m" && read -r url_typebot
    echo ""

    ##Pergunta o Dominio do Viewer
    echo -e "\e[97mPasso$amarelo 2/10\e[0m"
    echo -en "\e[33mDigite o Dominio para o Viewer do Typebot (ex: bot.autombot.art.br): \e[0m" && read -r url_viewer
    echo ""
    ...
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_typebot
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 5/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: autombot ou contato@autombot.art.br): \e[0m" && read -r usuario_email_typebot
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o N8N (ex: n8n.autombot.art.br): \e[0m" && read -r url_editorn8n
    echo ""
    
    ##Pergunta o Dominio do Webhook
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Webhook do N8N (ex: webhook.autombot.art.br): \e[0m" && read -r url_webhookn8n
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o Flowise (ex: flowise.autombot.art.br): \e[0m" && read -r url_flowise
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o PgAdmin 4 (ex: pgadmin.autombot.art.br): \e[0m" && read -r url_PgAdmin_4
    echo ""
    
    ##Pergunta o Email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/3\e[0m"
    echo -en "\e[33mDigite um email para o PgAdmin 4 (ex: contato@autombot.art.br): \e[0m" && read -r user_PgAdmin_4
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o dominio para o Nocobase (ex: nocobase.autombot.art.br): \e[0m" && read -r url_nocobase
    echo ""
    
    ##Pergunta o Email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite um email para o Nocobase (ex: contato@autombot.art.br): \e[0m" && read -r mail_nocobase
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Botpress (ex: botpress.autombot.art.br): \e[0m" && read -r url_botpress
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Wordpress (ex: autombot.art.br ou loja.autombot.art.br): \e[0m" && read -r url_wordpress
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o Baserow (ex: baserow.autombot.art.br): \e[0m" && read -r url_baserow
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/6\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r mail_baserow
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 3/6\e[0m"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: autombot ou contato@autombot.art.br): \e[0m" && read -r user_baserow
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o RabbitMQ (ex: rabbitmq.autombot.art.br): \e[0m" && read -r url_rabbitmq
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Uptime Kuma (ex: uptimekuma.autombot.art.br): \e[0m" && read -r url_uptimekuma
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o dominio para o Cal (ex: calcom.autombot.art.br): \e[0m" && read -r url_calcom
    echo ""
    
    ## Pergunta o email SMTP
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_calcom
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Mautic (ex: mautic.autombot.art.br): \e[0m" && read -r url_mautic
    echo ""
    ...
    echo -e "\e[97mPasso$amarelo 3/4\e[0m"
    echo -en "\e[33mDigite o Email de admin: (ex: contato@autombot.art.br): \e[0m" && read -r email_mautic
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o Appsmith (ex: appsmith.autombot.art.br): \e[0m" && read -r url_appsmith
    echo ""
...
while true; do
    ...
    read -r ip _ <<<$(hostname -I)
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o ip da vps (seu ip: $ip) ou dominio para Qdrant (ex: qdrant.autombot.art.br): \e[0m" && read -r ip_vps
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o Dominio para o WoofedCRM (ex: woofedcrm.autombot.art.br): \e[0m" && read -r url_woofed
    echo ""
    ...
    echo -e "\e[97mPasso$amarelo 4/3\e[0m"
    echo -e "$amarelo--> Evite os caracteres especiais: \!#$ e/ou espaço"
...
if [ $? -eq 0 ]; then
    ...
    criar_banco_pgvector_woofedcrm #> /dev/null 2>&1
else
...
echo ""
sleep 1
## Usa o serviço wait_woofedcrm para verificar se o serviço esta online
wait_woofedcrm
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o Dominio para o Formbricks (ex: formbricks.autombot.art.br): \e[0m" && read -r url_formbricks
    echo ""
    
    ## Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite um Email para o SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_formbricks
    echo ""
...
## --------------------------- ORION --------------------------- ##
  ...
  formbricks:
    ...
    environment:
      ...
      ## Solicitar licenta Self-hosting --> https://autombot.art.br/formbricks_licence/ <-- ##
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o NocoDB (ex: nocodb.autombot.art.br): \e[0m" && read -r url_nocodb
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Langfuse (ex: langfuse.autombot.art.br): \e[0m" && read -r url_langfuse
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Metabase (ex: metabase.autombot.art.br): \e[0m" && read -r url_metabase
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Odoo (ex: odoo.autombot.art.br): \e[0m" && read -r url_odoo
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o Dominio para a Uno API (ex: unoapi.autombot.art.br): \e[0m" && read -r url_unoapi
    echo ""

    ##Pergunta o Dominio do Chatwoot
    echo -e "\e[97mPasso$amarelo 2/11\e[0m"
    echo -en "\e[33mDigite o Dominio do Chatwoot já instalado (ex: chatwoot.autombot.art.br): \e[0m" && read -r url_chatwoot_uno
    echo ""
...
while true; do
    ...
    echo -e "\e[97mPasso$amarelo 3/5\e[0m"
    echo -en "\e[33mDigite o dominio do Chatwoot (ex: chatwoot.autombot.art.br): \e[0m" && read -r dominio_chatwoot
    echo ""

    ##Pergunta Dominio do Quepasa
    echo -e "\e[97mPasso$amarelo 4/5\e[0m"
    echo -en "\e[33mDigite o dominio do Quepasa (ex: quepasa.autombot.art.br): \e[0m" && read -r dominio_quepasa
    echo ""

    ##Pergunta Email do Quepasa
    echo -e "\e[97mPasso$amarelo 5/5\e[0m"
    echo -en "\e[33mDigite o email do Quepasa (ex: contato@autombot.art.br): \e[0m" && read -r email_quepasa
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o Quepasa (ex: quepasa.autombot.art.br): \e[0m" && read -r url_quepasa
    echo ""

    ##Pergunta o email para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o email para o Quepasa (ex: contato@autombot.art.br): \e[0m" && read -r email_quepasa
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o Dify AI (ex: dify.autombot.art.br): \e[0m" && read -r url_dify
    echo ""

    ##Pergunta o Dominio do Qdrant
    read -r ip _ <<<$(hostname -I)
    echo -e "\e[97mPasso$amarelo 2/9\e[0m"
    echo -en "\e[33mDigite o dominio do Qdrant (ex: http://$ip  ou http://qdrant.autombot.art.br): \e[0m" && read -r url_quedrant
    echo ""
    ...
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_dify
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o WebUI Ollama (ex: ollama.autombot.art.br): \e[0m" && read -r url_ollama
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/2\e[0m"
    echo -en "\e[33mDigite o dominio para a API Ollama (ex: apiollama.autombot.art.br): \e[0m" && read -r url_apiollama
    echo ""
...
while true; do
    ...
    echo -en "\e[33mDigite o dominio para o Affine (ex: affine.autombot.art.br): \e[0m" && read -r url_affine
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/7\e[0m"
    echo -en "\e[33mDigite o Email de Admin (ex: contato@autombot.art.br): \e[0m" && read -r email_affine
    echo ""
    ...
    echo -en "\e[33mDigite a Email SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_smtp_affine
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o dominio para o Docuseal (ex: docuseal.autombot.art.br): \e[0m" && read -r url_docuseal
    echo ""

    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite a Email SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_smtp_docuseal
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/9\e[0m"
    echo -en "\e[33mDigite o dominio para o Directus (ex: directus.autombot.art.br): \e[0m" && read -r url_directus
    echo ""

     ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 2/9\e[0m"
    echo -en "\e[33mDigite a Email de Admin (ex: contato@autombot.art.br): \e[0m" && read -r email_directus
    echo ""
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 4/9\e[0m"
    echo -en "\e[33mDigite a Email SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_smtp_directus
    echo ""
...
while true; do
    ...
    ## Pergunta o Dominio da ferramenta
    echo -e "\e[97mPasso$amarelo 1/5\e[0m"
    echo -en "\e[33mDigite o Dominio para o VaultWarden (ex: vaultwarden.autombot.art.br): \e[0m" && read -r url_vaultwarden
    echo ""
    
    ## Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 2/5\e[0m"
    echo -en "\e[33mDigite um Email para o SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_vaultwarden
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 1/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Grafana (ex: grafana.autombot.art.br): \e[0m" && read -r url_grafana
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 2/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o Prometheus (ex: prometheus.autombot.art.br): \e[0m" && read -r url_prometheus
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 3/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o cAdvisor (ex: cadvisor.autombot.art.br): \e[0m" && read -r url_cadvisor
    echo ""

    ##Pergunta o Dominio para aplicação
    echo -e "\e[97mPasso$amarelo 4/4\e[0m"
    echo -en "\e[33mDigite o Dominio para o NodeExporter (ex: node.autombot.art.br): \e[0m" && read -r url_nodeexporter
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/3\e[0m"
    echo -en "\e[33mDigite o dominio para o NextCloud (ex: nextcloud.autombot.art.br): \e[0m" && read -r url_nextcloud
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/1\e[0m"
    echo -en "\e[33mDigite o dominio para o Strapi (ex: strapi.autombot.art.br): \e[0m" && read -r url_strapi
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio para a ferramenta
    echo -e "\e[97mPasso$amarelo 1/2\e[0m"
    echo -en "\e[33mDigite o dominio para o PhpMyAdmin (ex: phpmyadmin.autombot.art.br): \e[0m" && read -r url_phpmyadmin
    echo ""
...
while true; do
    ...
    ##Pergunta o Dominio do Builder
    echo -e "\e[97mPasso$amarelo 1/10\e[0m"
    echo -en "\e[33mDigite o Dominio para o Supabase (ex: supabase.autombot.art.br): \e[0m" && read -r url_supabase
    echo ""
    ...
    ##Pergunta o Email SMTP
    echo -e "\e[97mPasso$amarelo 4/10\e[0m"
    echo -en "\e[33mDigite o Email para SMTP (ex: contato@autombot.art.br): \e[0m" && read -r email_supabase
    echo ""

    ##Pergunta o usuário do Email SMTP
    echo -e "\e[97mPasso$amarelo 5/10\e[0m"
    echo -e "$amarelo--> Caso não tiver um usuario do email, use o proprio email abaixo"
    echo -en "\e[33mDigite o Usuário para SMTP (ex: autombot ou contato@autombot.art.br): \e[0m" && read -r usuario_email_supabase
    echo ""
